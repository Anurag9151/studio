...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto p-4 group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center justify-center group-data-[collapsible=icon]:justify-center group-data-[state=expanded]:justify-start group-data-[state=expanded]:gap-2 overflow-hidden rounded-md p-2 text-left outline-none ring-ring transition-[width,height,padding,justify-content] hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 active:bg-accent active:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-accent data-[active=true]:font-medium data-[active=true]:text-accent-foreground data-[state=open]:hover:bg-accent data-[state=open]:hover:text-accent-foreground group-data-[collapsible=icon]:!size-10 [&>span:last-child]:group-data-[collapsible=icon]:opacity-0 [&>span:last-child]:group-data-[state=expanded]:opacity-100 [&>span:last-child]:transition-opacity [&>span:last-child]:ease-in-out [&>span:last-child]:duration-200 [&>svg]:size-5 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
